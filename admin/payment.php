...
{
	$sql="select f.flight_id as id, concat(f.departure_city,' ',f.arrival_city,' ',f.departure_time,' ',f.class_name) as flight from flights f";
...
<div  class="form_register">
    ...
    <select class="select-style gender" name="plain" onchange="showPayment(this.value)">
     <option value="select">flight..</option>
			<?php
			while ($row_flight=mysql_fetch_array($result))
...
<div id="response" >
<h1 style="text-align: center">Flight payment info will be listed here...</h1>
</div>
